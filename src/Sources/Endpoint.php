...
namespace Coco\JsonParser\Sources;

use Coco\JsonParser\Concerns\DetectsEndpoints;
use Coco\JsonParser\Concerns\GuzzleAware;
...
class Endpoint extends Source
{
     ...
     * @throws \Coco\JsonParser\Exceptions\GuzzleRequiredException
     */
